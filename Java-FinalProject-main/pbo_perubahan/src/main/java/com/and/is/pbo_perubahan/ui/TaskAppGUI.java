...
private void sortTasks(List<Task> tasks) {
    ...
    tasks.sort((task1, task2) -> {
        ...
        if ("Priority".equals(selectedCriteria)) {
            ...
            int priority1 = java.util.Arrays.asList(priorityOrder).indexOf(task1.getPriority());
            int priority2 = java.util.Arrays.asList(priorityOrder).indexOf(task2.getPriority());
